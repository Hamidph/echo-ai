    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative mesh-bg overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div className="orb orb-cyan w-[400px] h-[400px] top-1/4 -left-20" />
          <div className="orb orb-violet w-[300px] h-[300px] bottom-1/4 right-0" />
        </div>
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 w-full">
          ...
          <div className="max-w-md">
            ...
            <p className="text-xl text-gray-400 leading-relaxed">
              Join thousands of brands using probabilistic AI analysis to optimize their visibility in AI-generated responses.
            </p>
            ...
            <div className="mt-12 space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-white">Monte Carlo Simulations</h3>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-white">Multi-Provider Testing</h3>
