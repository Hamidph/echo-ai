---
name: onboarding-doc
description: Create onboarding documentation for Echo AI. Use when user says "write onboarding docs", "getting started guide", "new user guide", "API quickstart", "developer docs", or "how to onboard new team member".
